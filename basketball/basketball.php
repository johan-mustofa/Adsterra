  ...
  <div class="container">
    <div class="row">
        <div class="col-sm-4 col-md-2 col-md-2 sidebar">
            <div class="widget">
                <marquee><h5 class="font-alt"><?php echo $meta_title;?> Basketball</h5></marquee>
            </div>
        </div>
...
include("../app/grab.php");?>
                <?php 
                  $html = file_get_html('https://www.sofascore.com/api/v1/sport/basketball/events/live');
...
foreach($data['events'] as $elem)  {
    ...
    $id = $elem['id'];
    $background_image = $url_webs . "/assets/gsilvers/images/basketball.jpg";
    $date = new DateTime;
    ...
    $dates = $date->format('D, j M Y g:i A | T | e');
                ...
                ?>
                  ...
                  <a href="<?php echo $url_webs;?>basketball.php">
                    ...
                    <div class="menu-detail font-serif"><?php echo $league;?> | <?php echo $category;?> | <?php echo $status;?> </div>
                ...
                <?php 
                  ...
                  ?>
                    <div class="Cell-sc-t6h3ns-0 iqwpGQ" style="width: 100%; height: 360px; flex-direction: column; padding: 16px;">
                      <div style="color: rgb(128, 128, 128); margin: 0px 0px 4px; text-align: center;">
                      </div>
                    </div>
                              </div>
          </div>
