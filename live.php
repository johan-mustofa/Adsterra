      ...
      <div class="container">
         ...
         <div class="row mb-20">
            <div class="player center-block">
               <div class="layar" data-video="<?php if( isset($_GET['i']) ) : ?><?php echo "https://i.imgur.com/" . $_GET['i'] . ".jpeg";?><?php elseif( empty($_GET['i']) ) : ?><?php echo $url_webs;?>assets/gsilvers/images/soccer.jpg<?php endif;?>">
                  <!--modal-direct-auth-->
