...
<html lang="en-US" dir="ltr">
  <head>
    ...
    <title><?php echo $title;?>Football Live Stream | Full Match</title>
      ...
      <div class="page-loader">
        <div class="loader">Loading...</div>
                    ...
                    <div class="main">
                      <!-- GAM -->
  <div class="container">
    <h3 class="well text-center"><?php echo $title;?> Football Live Stream </h3>
    <div class="row mb-20">
    <div class="player center-block">
        <div class="layar" data-video="<?php if( isset($_GET['gsilvers']) ) : ?><?php echo $background_image;?><?php elseif( empty($_GET['gsilvers']) ) : ?><?php echo $url_webs;?>/assets/gsilvers/images/soccer.jpg<?php endif;?>">
            <!--modal-direct-auth-->
