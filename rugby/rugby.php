  ...
  <div class="container">
    <div class="row">
        <div class="col-sm-4 col-md-2 col-md-2 sidebar">
            <div class="widget">
                <marquee><h5 class="font-alt"><?php echo $meta_title;?> Rugby</h5></marquee>
            </div>
        </div>
...
include("../app/grab.php");?>
                <?php 
                  $html = file_get_html('https://www.sofascore.com/api/v1/sport/rugby/events/live');
...
foreach($data['events'] as $elem)  {
    ...
    $id = $elem['id'];
        $background_image = $url_webs . "/assets/gsilvers/images/rugby.jpg";
    $date = new DateTime;
    ...
    $dates = $date->format('D, j M Y g:i A | T | e');
                ...
                ?>
                  ...
                  <a href="<?php echo $url_webs;?>rugby.php">
