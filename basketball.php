...
<html lang="en-US" dir="ltr">
  <head>
    ...
    <title><?php echo $title;?>Basketball Live Stream | Full Match</title>
        ...
        <div class="loader">Loading...</div>
              ...
              <?php include("menu.php");?>
                    <div class="main">
                      <!-- GAM -->
  <div class="container">
    <h3 class="well text-center"><?php echo $title;?> Basketball Live Stream </h3>
    <div class="row mb-20">
    <div class="player center-block">
        <div class="layar" data-video="<?php if( isset($_GET['gsilvers']) ) : ?><?php echo $background_image;?><?php elseif( empty($_GET['gsilvers']) ) : ?><?php echo $url_webs;?>/assets/gsilvers/images/basketball.jpg<?php endif;?>">
            <!--modal-direct-auth-->
